...
const recentSubmissions = [
  {
    ...
    title: 'Maintenance response was clear and timely',
  },
  {
    date: 'Jun 12, 2026',
    label: 'Suggestion',
    title: 'Add weekend appointment slots for working tenants',
  },
]
...
export function CreateFeedbackPage() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setRating(0)
    setRelatedRequest('')
    setStatusMessage('Tenant feedback saved as a frontend preview.')
  }

  return (
    <div className="pb-4">
      <TenantPageIntro eyebrow="Create Feedback" title="Create tenant feedback" />
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start">
        ...
        >
          <section className="grid gap-3 rounded-lg border border-slate-200 bg-[#fafafa] p-4 sm:grid-cols-3">
            ...
            <TenantMeta icon={MessageSquare} label="Source" value="Verified tenant portal" />
          </section>
          ...
          <section className="mt-5 grid gap-4 md:grid-cols-[minmax(0,1fr)_220px]">
            ...
            <div>
              ...
              <div
                ...
                className="mt-2 flex h-11 items-center gap-1 rounded-lg border border-slate-200 bg-white px-2"
                role="radiogroup"
              >
                {[1, 2, 3, 4, 5].map((value) => (
                  <button
